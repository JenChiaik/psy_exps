...
class Configutarion:
    ...
    def __init__(self):
        ...
        self.__res_conductor, self.__res_subjects = (1920,1080), (1920,1080) #双屏调试

        self.__keys_nextpage = 'return' #主试操作页面
        self.__keys_operation = ['space','return','left','right','up','down'] #仅供键盘调试
        self.__keys_color_picker = {'up':'up','down':'down'} #仅供键盘调试
        self.__keys_shape_picker = {'left':'left', 'right':'right'} #仅供键盘调试
        self.__keys_coloring = 'space' #仅供键盘调试

        # 静态页面最小时间
        self.__wait_text, self.__wait_break = 0, 0
        ...
        # 时限页面：时间与文字
        self.__intermezzo_dict = {'rest':[60, '静息阶段（1分钟）'],
        ...
        for i in self.__intermezzo_dict.keys():
            self.__intermezzo_dict[i][0] = 3

        # A/B 类得分条件
        self.__allowed_a1 = [(5, 3, 3), (5, 4, 2), (5, 5, 4),
                    (6, 3, 2), (6, 4, 4), (6, 5, 3),
                    (7, 3, 3), (7, 4, 4), (7, 5, 2),
                    (8, 3, 4), (8, 4, 2), (8, 5, 3)] #图形数量，形状种类，颜色种类

        self.__allowed_b1 = [(5,2,0,0,0,3,2), (5,3,0,1,0,2,2), (5,4,1,1,0,2,1),
        ...
        self.__allowed_a2 = [(5, 3, 4), (5, 4, 3), (5, 5, 2),
                    (6, 3, 3), (6, 4, 4), (6, 5, 2),
                    (7, 3, 3), (7, 4, 2), (7, 5, 4),
                    (8, 3, 2), (8, 4, 3), (8, 5, 4)] #图形数量，形状种类，颜色种类

        self.__allowed_b2 = [(5,2,1,0,0,0,4), (5,3,1,0,0,1,3), (5,4,1,1,0,1,2),
    ...
    @property
    def res_conductor(self):
        return self.__res_conductor
    
    @property
    def res_subjects(self):
        return self.__res_subjects
    
    @property
    def keys_nextpage(self):
        return self.__keys_nextpage
    
    @property
    def keys_operation(self):
        return self.__keys_operation
    
    @property
    def keys_color_picker(self):
        return self.__keys_color_picker
    
    @property
    def keys_shape_picker(self):
        return self.__keys_shape_picker
    
    @property
    def keys_coloring(self):
        return self.__keys_coloring
    
    @property
    def wait_text(self):
        return self.__wait_text
    
    @property
    def wait_break(self):
        return self.__wait_break
    ...
    @property
    def intermezzo_dict(self):
        return self.__intermezzo_dict
    
    @property
    def allowed_a1(self):
        return self.__allowed_a1
    
    @property
    def allowed_b1(self):
        return self.__allowed_b1
    
    @property
    def allowed_a2(self):
        return self.__allowed_a2
    
    @property
    def allowed_b2(self):
        return self.__allowed_b2
    
    @property
    def graph_dict_exercise(self):
        return self.__graph_dict_exercise
    
    @property
    def graph_dict_stage1(self):
        return self.__graph_dict_stage1
    
    @property
    def graph_dict_stage2(self):
        return self.__graph_dict_stage2
