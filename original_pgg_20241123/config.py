...
class Configuration:
    ...
    def static_text(self):
        static_param = {
            'exercise_pgg':'接下来是练习阶段。\n目标：熟悉操作，向公共账户、个人账户各分配 5 枚代币。\n\n练习阶段不计入最终收益。',
            'formal_pgg':'接下来是若干轮正式任务。\n\n正式阶段的收益会按比例折算为最终的被试费。',
            'intermezzo':'本阶段任务结束。\n\n即将进入下一阶段……',
            'call_me':'本阶段任务结束。\n\n请呼唤主试。',
            'add_public_box':'【LB】增加公共账户投入',
            'add_private_box':'【RB】增加私人账户投入',
            'confirm_token':'确认：先按【Y】，再按【A】',
    ...
    def topic_dict(self):
        static_param = {
            1: {
                ...
                9:"我经常关注最近网上有什么热搜、热“梗”。",
                10:"如果任务能顺利完成，就不必在乎过程是否完美。",
                11:"我经常为自己以前的选择而后悔。",
