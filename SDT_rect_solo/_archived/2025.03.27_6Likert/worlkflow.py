...
def launch():
    ...
    exp.disp_pic(wait=5, auto=False, pic_0='intro_1.png')
    exp.disp_pic(wait=5, auto=False, pic_0='intro_2.png')
    exp.disp_pic(wait=5, auto=False, pic_0='intro_3.png')
    exp.disp_pic(wait=5, auto=False, pic_0='intro_4.png')
    ...
    # block2
    exp.disp_pic(wait=5, auto=False, pic_0='warning.png')
    exp.disp_pic(wait=5, auto=False, 
                 pic_0='punish_MS.png' if exp.exp_param['launch_mode'] == 1 \
                    else 'punish_FA.png')
    exp.disp_text(wait=1, auto=False, text_0=config.text['start_formal'])
    exp.block_SD(process_name='formal_punish_MS' if exp.exp_param['launch_mode'] == 1 \
    ...
    exp.disp_pic(wait=5, auto=False, pic_0='warning.png')
    exp.disp_pic(wait=5, auto=False, 
                 pic_0='punish_FA.png' if exp.exp_param['launch_mode'] == 1 \
                    else 'punish_MS.png')
    exp.disp_text(wait=1, auto=False, text_0=config.text['start_formal'])
    exp.block_SD(process_name='formal_punish_FA' if exp.exp_param['launch_mode'] == 1 \
