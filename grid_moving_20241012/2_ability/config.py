...
class Configuration:
    ...
    def __init__(self):
        ...
        self.__resolution = (2560,1440) #2.5k正式实验
        ...
        self.__graph_param = {'tiny_text_scaling':0.22, 'small_text_scaling':0.32, 'medium_text_scaling':0.42, 
                              ...
                              'basic_unit_width':2, 'legal_unit_width':4, 'moveto_unit_width':12, }
        ...
        self.__colorset = {'default':'#1a1a1a', 'obvious':'#ce0058', 'obvious_2':'#3e6f6f', 'bg_window':'#ffffff', 
                           ...
                           'line_moveto':'#ef8fdf', 'line_default':'#1a1a1a', 'line_legal':'#af9cd9', 
                           'team_related':'#1a1a1a', 'self_related':'#f47f3e', 'allay_related':'#2fac5f', }
        ...
        self.__grid_series_test = {
            0:{'m':7, 'n':7, 'init_loca':(4,4),'init_step':5, 'init_role':0, 'element':{}},
            }

        self.__grid_series_exercise = {
            101:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            102:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':1, 'element':{}},
            }
        
        self.__grid_series_strategy = {
            1:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':27, 'init_role':0, 'element':{}},
            2:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':27, 'init_role':1, 'element':{}},
            3:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':27, 'init_role':0, 'element':{}},
            4:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':27, 'init_role':1, 'element':{}},
        }

        self.__grid_series_formal = {
            1:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            2:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            3:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':1, 'element':{}},
            4:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            5:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':1, 'element':{}},
            6:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            7:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':0, 'element':{}},
            8:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':1, 'element':{}},
            }
        ...
        self.__opinion_confirm = {'aye':'您选择了“是”', 'nay':'您选择了“否”'}

        self.__thinking_guide = '按【X】或【B】进行选择。\n\n可以修改您的选择，确认无误后再按【LB】。\n\n作答时间会影响测验成绩。'
        self.__thinking_confirm = {'aye':'您选择了【X】选项', 'nay':'您选择了【B】选项'}
...
config.condit_element(grid_series=config.grid_series_exercise,
...
if __name__ == '__main__':
    ...
    print(config.grid_series_exercise[0]['element'])
    print()
    print(config.grid_series_exercise[1]['element'])
    print()
