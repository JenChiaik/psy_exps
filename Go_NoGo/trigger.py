...
class Trigger:
    ...
    def __init__(self, mode:str='LSL'):
        ...
        if self.mode == 'LSL':
            ...
            self.port = serial.Serial(port='COM4', baudrate=115200, timeout=1)
...
if __name__ == '__main__':
    ...
    while time.time() - time_init <= 300:
        ...
        marker_value = rd.randint(1,2)

        clock_init += interval
        EventMarker.send(value=marker_value)
        print(f'Sending value: {bytes([marker_value])}')
