...
class Configuration:
    ...
    def __init__(self):
        ...
        self.__grid_series_exercise_2 = { #重置步数练习：重置步数 - 得分 - 重置步数 - 得分 - 结束。
            120:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':2, 'init_role':1, 
        ...
        self.__grid_series_formal = {
            ...
            10:{'m':7, 'n':7, 'init_loca':(3,3), 'init_step':11, 'init_role':1, 'element':{}},
            }
...
if __name__ == '__main__':
    ...
    print(config.grid_series_exercise_1[110]['element'])
    print()
    print(config.grid_series_exercise_1[111]['element'])
    print()
